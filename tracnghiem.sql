...
(2, 'Phép ‘và’ trong C++ kí hiệu là:', '||', '!', '&&', 'and', 'C'),
...
(15, 'Để khai báo biến tệp đồng thời mở tệp để đọc dữ liệu ta dùng cú pháp nào sau đây?', 'ifstream tên_biến_tệp (xâu_tên_tệp);', 'ifstream tên_biến_tệp;', 'ifstream (xâu_tên_tệp);', 'tên_biến_tệp ifstream (xâu_tên_tệp);', 'A'),
(16, 'Cho đoạn chương trình sau: int s=0; for(int i=1;i<=5;i++) s=s+i; Sau khi thực hiện đoạn chương trình trên giá trị của s là:', '1', '15', '6', '21', 'B'),
